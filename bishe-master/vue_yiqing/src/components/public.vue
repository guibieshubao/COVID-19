    ...
    <div class="yq">
      ...
      <el-card>
        <div class="">
          ...
          <div ref="mapbox" style="height: 400px; width: 600px"></div></div
      ></el-card>

      <!-- 疫情详情跳转 -->
      <el-card>
        <!-- 国内疫情详情 -->
        <div class="td"><a href="http://127.0.0.1:5173/">国内疫情详情</a></div>
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="最新消息" name="first">
            <ul class="tt">
              <li>
                <a
                  href="http://www.gov.cn/xinwen/2022-12/12/content_5731442.htm"
                  >截至12月11日24时新型冠状病毒肺炎疫情最新情况</a
                >
              </li>
              <li>
                <a
                  href="http://www.gov.cn/xinwen/2022-12/11/content_5731373.htm"
                  >新冠病毒疫苗接种情况（截至12月10日）
                </a>
              </li>
              <li>
                <a
                  href="http://www.gov.cn/xinwen/2022-12/11/content_5731342.htm"
                  >截至12月10日24时新型冠状病毒肺炎疫情最新情况</a
                >
              </li>
              <li>
                <a
                  href="http://www.gov.cn/xinwen/2022-12/10/content_5731258.htm"
                  >新冠病毒疫苗接种情况（截至12月9日）</a
                >
              </li>
            </ul>
          </el-tab-pane>
          ...
          >
          <el-tab-pane label="防控指南" name="third">
            <ul class="tt">
              <li>
                <a
                  href="http://www.gov.cn/xinwen/2022-12/12/content_5731442.htm"
          ...
          >
          <el-tab-pane label="各地防控" name="fourth">
            <ul class="tt">
              <li>
                <a
                  href="http://www.gov.cn/xinwen/2022-12/12/content_5731442.htm"
